...
| Code     | [IfStatementAnalyzer]([IfStatementAnalyzer](https://github.com/DotNetAnalyzers/PropertyChangedAnalyzers/blob/master/PropertyChangedAnalyzers/NodeAnalyzers/IfStatementAnalyzer.cs))
