namespace PropertyChangedAnalyzers.PropertyChanged
{
    ...
    using PropertyChangedAnalyzers.PropertyChanged.Helpers;

    using AnalysisResult = PropertyChangedAnalyzers.PropertyChanged.Helpers.AnalysisResult;
