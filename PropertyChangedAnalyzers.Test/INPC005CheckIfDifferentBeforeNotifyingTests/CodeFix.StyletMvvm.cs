    ...
    public class ViewModel : Stylet.PropertyChangedBase
    {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                AnalyzerAssert.CodeFix<INPC005CheckIfDifferentBeforeNotifying, CheckIfDifferentBeforeNotifyFixProvider>(testCode, fixedCode, "Use PropertyChangedBase.SetAndNotify");
                AnalyzerAssert.FixAll<INPC005CheckIfDifferentBeforeNotifying, CheckIfDifferentBeforeNotifyFixProvider>(testCode, fixedCode, "Use PropertyChangedBase.SetAndNotify");
            }
