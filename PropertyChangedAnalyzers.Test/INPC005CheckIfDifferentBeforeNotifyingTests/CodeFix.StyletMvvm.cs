    ...
    public class ViewModel : Stylet.PropertyChangedBase
    {
        ...
        public string Name
        {
            ...
            set => this.SetAndNotify(ref this.name, value);
                ...
                AnalyzerAssert.CodeFix(Analyzer, CodeFix, ExpectedDiagnostic, testCode, fixedCode, fixTitle: "Use PropertyChangedBase.SetAndNotify");
                AnalyzerAssert.FixAll(Analyzer, CodeFix, ExpectedDiagnostic, testCode, fixedCode, fixTitle: "Use PropertyChangedBase.SetAndNotify");
            }
