    ...
    public class ViewModel : Microsoft.Practices.Prism.Mvvm.BindableBase
    {
        ...
        public string Name
        {
            ...
            set => this.SetProperty(ref this.name, value);
                ...
                AnalyzerAssert.CodeFix(Analyzer, CodeFix, ExpectedDiagnostic, testCode, fixedCode, fixTitle: "Use BindableBase.SetProperty");
                AnalyzerAssert.FixAll(Analyzer, CodeFix, ExpectedDiagnostic, testCode, fixedCode, fixTitle: "Use BindableBase.SetProperty");
            }
