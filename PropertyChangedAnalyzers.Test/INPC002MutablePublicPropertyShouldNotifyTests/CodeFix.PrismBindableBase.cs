    ...
    public class Foo : Microsoft.Practices.Prism.Mvvm.BindableBase
    {
        ...
        public int Bar
        {
            ...
            set => this.SetProperty(ref this.bar, value);
                ...
                AnalyzerAssert.CodeFix(Analyzer, CodeFix, ExpectedDiagnostic, testCode, fixedCode, fixTitle: "BindableBase.SetProperty.");
                AnalyzerAssert.FixAll(Analyzer, CodeFix, ExpectedDiagnostic, testCode, fixedCode, fixTitle: "BindableBase.SetProperty.");
            }
