    ...
    public class Foo : GalaSoft.MvvmLight.ViewModelBase
    {
        ...
        public int Bar
        {
            ...
            set => this.Set(ref this.bar, value);
                ...
                AnalyzerAssert.CodeFix(Analyzer, Fix, ExpectedDiagnostic, testCode, fixedCode, fixTitle: "ViewModelBase.Set.");
                AnalyzerAssert.FixAll(Analyzer, Fix, ExpectedDiagnostic, testCode, fixedCode, fixTitle: "ViewModelBase.Set.");
            }
