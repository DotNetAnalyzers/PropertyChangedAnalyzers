namespace PropertyChangedAnalyzers.Test.INPC001MutablePublicPropertyShouldNotifyTetss
{
    ...
    using INPC001MutablePublicPropertyShouldNotify = PropertyChangedAnalyzers.INPC001MutablePublicPropertyShouldNotify;

    internal class CodeFixEquality : CodeFixVerifier<INPC001MutablePublicPropertyShouldNotify, MakePropertyNotifyCodeFixProvider>
    {
        [TestCase("int")]
        [TestCase("int?")]
