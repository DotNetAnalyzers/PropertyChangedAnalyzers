...
#pragma warning restore WPF0041
        ...
        [TestCaseSource(nameof(AllAnalyzers))]
        public async Task RecursionInSet(DiagnosticAnalyzer analyzer)
        {
...
namespace RoslynSandbox.Client
{
    ...
    public class Foo : RoslynSandbox.Core.ViewModelBase
    {
        ...
        [TestCaseSource(nameof(AllAnalyzers))]
        public async Task RecursionInOnPropertyChanged(DiagnosticAnalyzer analyzer)
        {
            var viewModelBaseCode = @"
namespace RoslynSandbox.Core
{
...
namespace RoslynSandbox.Client
{
    ...
    public class Foo : RoslynSandbox.Core.ViewModelBase
    {
        ...
        [TestCaseSource(nameof(AllAnalyzers))]
        public async Task RecursiveProperty(DiagnosticAnalyzer analyzer)
        {
            var testCode = @"
namespace RoslynSandbox.Client
{
